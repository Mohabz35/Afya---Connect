    ...
    <div className="flex flex-col min-h-screen">
      ...
      <header className="px-4 lg:px-6 h-14 flex items-center border-b">
        ...
        <nav className="ml-auto flex gap-4 sm:gap-6">
          ...
          <Link className="text-sm font-medium hover:underline underline-offset-4" href="#solution">
            Solution
          </Link>
          <Link className="text-sm font-medium hover:underline underline-offset-4" href="#market">
            Market
          </Link>
